...
{
    public class First13ErrorsValidator
        : CommonFirstErrorsValidator
    {
        public First13ErrorsValidator(IValidationContext context) : base(context)
        {
        }

        protected override ValidationStepType Type
            => ValidationStepType.CalculationContributionsFirst13ErrorsValidator;
