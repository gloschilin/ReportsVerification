...
{
    public class SecondErrors11Validator
        : CommonSecondErrorsValidator
    {
        public SecondErrors11Validator(IValidationContext context) : base(context)
        {
        }

        protected override ValidationStepType Type 
            => ValidationStepType.CalculationContributionsSecondErrors11Validator;
