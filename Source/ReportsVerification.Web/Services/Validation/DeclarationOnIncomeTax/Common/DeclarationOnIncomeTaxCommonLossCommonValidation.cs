...
{
    public abstract class DeclarationOnIncomeTaxCommonLossCommonValidation : DeclarationOnIncomeTaxCommonValidation
    {
        protected DeclarationOnIncomeTaxCommonLossCommonValidation(IValidationHandler handler) : base(handler)
        {
        }
