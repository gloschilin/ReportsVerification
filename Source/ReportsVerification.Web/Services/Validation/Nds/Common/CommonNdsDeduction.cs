...
{
    public abstract class CommonNdsDeduction: CommonConcreteValidationService
    {
        private readonly ICatalogRepository _catalogRepository;
        protected abstract int Quarter { get; }

        protected CommonNdsDeduction(IValidationHandler handler, ICatalogRepository catalogRepository) : base(handler)
        {
